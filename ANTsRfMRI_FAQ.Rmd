...
plotANTsImage(avg,slices='9x26x4',axis=3,outname=onm)
```

![Axial slices](./TEMP_figslices.png)
...
```{r, echo=TRUE,warning=F,message=F,cache=FALSE}
  ...
  bold2d<-as.antsImage(boldarr[20,20,,])
  onm2da=paste(figpre,'slices2da.png',sep='')
  plotANTsImage(bold2d,outname=onm2da)
```
![Time Slices Before Motion Correction](./TEMP_figslices2da.png)
...
## Show Time Slice After Motion Correction
...
```
![Time Slices After Motion Correction](./TEMP_figslices2db.png)
