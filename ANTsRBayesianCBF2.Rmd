...
robustnessvalue<-0.0 # higher rejects more data. 0.9 or less - keep all
...
```{r perfpro, echo=TRUE,warning=F,message=F,cache=FALSE}
  perfpro <- aslPerfusion( pcasl, interpolation="linear", skip=25,
        dorobust=robustnessvalue, useDenoiser=denoisingComponents,  
        moreaccurate=motionAcc, verbose=1, mask=mask, 
        ncompcor=0 ) 
